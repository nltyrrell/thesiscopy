...
further discussed shortly. The regression lines for all three evaporative 
fractions are all above unity, indicating that in the mean the land response is 
amplified compared to the SST forcing. There is also a relationship between the 
evaporative fraction of the land and $R_{l/o}$
