...
appropriate tool, as by definition the surface properties must represent either 
...
PfixT = 600\\
Evap Fr. = 0.3 :  Phi = 1.63, corr. = 0.7, rs = 2.35\\
Evap Fr. = 0.5 :  Phi = 1.25, corr. = 0.79, rs = 1.58\\
Evap Fr. = 0.7 :  Phi = 1.11, corr. = 0.78, rs = 1.42\\
}
\label{fig:SCM_Rlo}
\end{figure}
