...
mode) as described in \citet{Sobel2000}, which relies on the WTG approximation 
as discussed in section \ref{intro:wtg}. For this setup the free tropospheric 
temperatures (i.e. the temperature above, say, 
\SIrange{850}{700}{\hecto\pascal}) are specified and remain fixed, allowing the 
vertical velocity and precipitation to be prognostic variables.
