...
from \citet{Morcrete1991}. The fractional cloud scheme of \citet{Bony2001} is 
...
velocity and, hence precipitation to be prognostic variables.
...
results were often realistic. For example, initial estimates of climate 
...
interaction between systems increase.  This can inhibit our understanding of the 
...
and regional response to external forcings and sensitivity to changes in the mean 
...
\citep{Dommenget2015} including arctic amplification and the land/ocean warming 
contrast.
