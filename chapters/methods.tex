...
ACCESS (Australian Community Climate and Earth System Simulator) Sensitivity 
experiments were performed with the UK Meteorological Office Unified Model AGCM 
with HadGEM2 atmospheric physics (\citet{Davies2005}; \citet{Martin2010}; 
\citet{Bellouin2011}) at an atmospheric resolution of N48 ($3.75^{\circ} \times 
2.5^{\circ}$). The model was either forced with prescribed SSTs or contained a 
  slab ocean (the slab ocean is described in section \ref{methods:pacemaker}).
...
changes in CO$_2$. Both the land and ocean columns able to respond to the 
forcing. As this study primarily deals with natural variability a CO$_2$ forced 
...
\begin{figure}[ht]
	\includegraphics[width=1.0\textwidth]{{2007_Abbot.Emanuel_Fig1}.pdf}
