...
We utilised the Massachusetts Institute of Technology (MIT) model. First 
described by \citet{Renno94} and updated in \citet{Bony2001}.  The model can be 
run as a single column or as a two dimensional model in a zonal or meridional 
direction.
