...
the ocean surface temperature we can use a single column model to study the 
land/ocean temperature contrast using the Weak Temperature Gradient (WTG) 
...
\subsubsection{Atmospheric profiles in temperature and relative humidity}
