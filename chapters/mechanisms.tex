...
tropospheric temperature profiles above an ocean surface. As we do this we will 
test the model response against the expected theoretical response by looking at 
temperature profiles as we vary the SST about a mean tropical value.
By using both small and large variations in SST above and below the chosen mean 
value allow we can test the response of the model to anomalies of a magnitude 
similar to that seen in interannual SST variability.
