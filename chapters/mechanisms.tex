...
\SI{1}{degreeCeclius} increments from \SI{19}{degreeCelcius} to 
\SI{34}{degreeCelcius}, to test the response of the model over a wide range of 
SSTs.
...
anomalies are a result of heating by moist convection.
