...
Regarding the warmer ocean/cooler profiles of relative humidity are quite 
telling. For Figure \ref{fig:tdm_rhprof} a run with one ocean and three land 
columns is shown, and just two SSTs are plotted as the results are similar for a 
...
region, from \SIrange{940}{800}{\hecto\pascal} coincides with the steeper lapse 
rate of $\theta$
