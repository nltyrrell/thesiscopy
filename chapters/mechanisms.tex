...
$T_{ocean}$ (b), with the green line for the column of air above land, and blue 
for the column of air above ocean.  In the simulation without any SST 
...
the upper level temperature shows a strong relationship with the surface 
$T_{land}$ variability. In particular the relation of $T_{land}$ with upper 
level temperatures over ocean areas shows a strong increase with height, with 
values larger than unity between 500hPa to 200hPa. 
...
\begin{figure}[ht]
		\includegraphics[width=0.45\textwidth]{{linreg_land_sans_profile}.eps}
