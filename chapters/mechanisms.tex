...
increases.  Comparing this to the profile of $\theta$ in Figure 
\ref{fig:scmthprof} a) we see some similarities in the mean profile (the black 
line), due the different LCL heights, but it is clear that the land profile 
diverges from the ocean column $\Gamma_m^*$ above the LCL. changes in land not 
oc
...
\caption{Profiles of theta (a), change in theta from mean theta value (b), 
	change in theta from mean, all profiles averaged into five bins (c). Shows 
