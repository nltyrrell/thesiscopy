...
We have a seen a similarity between the Joshi theory and the interannua 
response. This shows the mechanism appears active in the statistics of the 
Pacemaker experiment, now we want to explore this further. To investigate this 
the physical mechanisms we will use a simpler model, one that we can limit the 
...
test the model response against the expected theoretical response.
